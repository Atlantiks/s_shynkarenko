...
public class CarV9 {
    ...
    public void drive(double i, String destination) {
        ...
        if (fuelVolumeInTank < 0) {
            System.out.println("При выбранной схеме заправки авто недостаточно топлива в баке для поездки в " + destination);
            System.out.println("Произведите перезапуск программы");
            System.exit(0);
        } else {
            System.out.println("Едем в " + destination + ". " + i + " км ...");
        }
    }
